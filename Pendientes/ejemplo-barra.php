...
<body>
    ...
    $sql = "SELECT Dia, COUNT(*) AS Cantidad, (SELECT AVG(Diferencia) FROM `$tabla7` WHERE $fila9  = $variable) AS PromedioGeneral FROM `$tabla7` WHERE $fila9  = $variable GROUP BY Dia ORDER BY Cantidad DESC LIMIT 1;";
    //echo $sql;
