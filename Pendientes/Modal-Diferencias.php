  ...
  <div class="modal-dialog modal-dialog-centered delete-modal">
    <div class="modal-content">
      ...
      <form method="POST" action="recib_Delete-Dif.php">
        ...
        <input type="hidden" name="ID_Pendientes" value="<?php echo $mostrar['ID_Pendientes']  ?>">
        <input type="hidden" name="link" value="./ejemplo-barra.php?variable=<?php echo $mostrar['ID_Pendientes']  ?>">
