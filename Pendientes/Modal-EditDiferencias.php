    ...
    <div class="modal-content">
      ...
      <form method="POST" action="recib_Edit-Dif.php">
        ...
        <div class="modal-body div1" id="cont_modal">
            ...
            <!--
            <div class="form-group">
                <label for="recipient-name" class="col-form-label">Diferencia en Dias</label>
                <input type="number" id="diferencia" name="diferencia" class="form-control" value="<?php echo $mostrar['Diferencia'] ; ?>">
                <?php //echo $fecha_actual; ?>
            </div>
            -->
             ...
             <?php
                ...
                if ($id > $ID_Menor) {
                    ...
                    <div class="form-group">
                        ...
                        <input type="datetime-local" disabled="disabled"  class="form-control" value="<?php echo $fecha_anterior ?>">
                    </div>    
                    ...
                    <div class="form-group">
                        <label for="recipient-name" class="col-form-label">Fecha de Anterior Registro</label>
                        <input type="datetime-local" id="fecha_antigua" name="fecha_antigua" class="form-control" min="01-01-2000 00:00:01">
                    </div>    
                    <?php 
                }
