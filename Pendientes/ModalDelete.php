    ...
    <div class="modal-content">
      ...
      <form action="recib_Delete.php" method="POST">
        ...
        <div class="modal-footer flex-column border-top-0">
          ...
          <button type="submit" name="Mangas" class="btn btn-warning btn-lg w-100 mx-0 mb-2">
            <i class="fa-solid fa-delete-left  me-2"></i>Borrar de Pendientes, Mover a Mangas
          </button>

          <button type="submit" name="Finalizados" class="btn btn-danger btn-lg w-100 mx-0">
            <i class="fas fa-trash-alt me-2"></i>
            Borrar de Pendientes, Mover a Finalizados
          </button>
        </div>
      </form>
    </div>
