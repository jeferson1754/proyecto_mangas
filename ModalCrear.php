      ...
      <form id="my-form" name="form-data" action="recibCliente.php" method="POST">
        ...
        <div class="modal-body" id="cont_modal">
          ...
          <div class="form-group">
            ...
            <input class="form-control" id="municipio" name="fila3" oninput="actualizarValorMunicipioInm()" type="number" required>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <select name="fila6" class="form-control" required>
              ...
              <option value="<?php echo $valor; ?>"><?php echo $lista; ?></option>
              <?php
          ...
          <div class="form-group">
            <div class="todo">
              <label class="container">
                ...
                echo "<input type='checkbox' name='Anime' value='SI'>";
