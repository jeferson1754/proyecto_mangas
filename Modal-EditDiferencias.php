    ...
    <div class="modal-content">
      ...
      <form method="POST" action="recib_Edit-Dif.php">
        ...
        <div class="modal-body">
          ...
          <?php
          $sql3 = "SELECT MIN(ID) AS ID_Menor FROM diferencias WHERE ID_Manga = '$variable'";
          $result3 = mysqli_query($conexion, $sql3);
          $row3 = mysqli_fetch_assoc($result3);
          $ID_Menor = $row3['ID_Menor'];

          $sql4 = "SELECT Fecha FROM diferencias WHERE ID < '$id' AND ID_Manga = '$variable' ORDER BY ID DESC LIMIT 1";
