                ...
                <table id="animeTable" class="table custom-table">
                    <thead>
                        <tr>
                            ...
                            <th class="progress-cell">Personajes</th>
                            <th class="progress-cell">Arte</th>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><a href="<?php echo $mostrar['Link'] ?>" title=" <?php
                                                                                        echo !empty($mostrar[$fila2]) ? "Correcto" : "Faltante"; ?>" target="_blanck" style="text-decoration: none;"><?php echo $mostrar['Nombre'] ?></a></td>
                                ...
                                <td>
                                    <div class="action-buttons">
                                        ...
                                        <a href="editar_stars.php?id=<?php echo $mostrar['ID']; ?>&nombre=<?php echo $variable_nombre; ?>"
